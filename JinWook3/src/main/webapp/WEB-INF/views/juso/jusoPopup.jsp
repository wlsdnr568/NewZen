...
// 	검색 U01TX0FVVEgyMDE4MTIwNjEzMzczNTEwODM1MTQ=
// 	팝업 U01TX0FVVEgyMDE4MTIwNjEzNDAzOTEwODM1MTU=
	var confmKey = "U01TX0FVVEgyMDE4MTIwNjEzNDAzOTEwODM1MTU=";	
...
<body onload="init();">
	...
	<form id="form" name="form" method="post" style="width: 700px;height: 500px;'border: 1px solid black'">
