(function (a) {
	...
	a.extend(a.jqx._jqxForm.prototype, {
		...
		// 190107_kmh 코드헬퍼 이벤트핸들러 등록
		_setCodeHelper : function(id) {
		    if(!this.isInitialized) {
		        return false
		    }
		    
		    let event = new a.Event("setCodeHelper");
		    event.args = {
	            id : id
		    };
		    event.owner = this;
		    
		    let trigger = this.host.trigger(event);
		...
		_initTextTool: function (seq) {
			...
			_this.host.find("#" + id).on("keydown", function (event) {
