...
<script type="text/javascript" src="<c:url value="/resources/js/common/mainGrid.js"/>"></script>
<script type="text/javascript" src="<c:url value="/resources/js/common/subGrid.js"/>"></script>
