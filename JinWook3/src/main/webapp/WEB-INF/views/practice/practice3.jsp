...
<body>
	...
	<div style="width:10%; margin: 0 auto"><a href="/test/practice/practice2">이전 페이지</a></div>
	<div style="width:10%; margin: 0 auto"><a href="/test/practice/practice4">다음 페이지</a></div>
</body>
</html>
