...
<body>
	...
	<div style="width:10%; margin: 0 auto"><a href="/test/practice/practice1">다음 페이지</a></div>
	<div style="width:10%; margin: 0 auto"><a href="/test/practice/practiceF">마지막 페이지</a></div>
</body>
</html>
