                    ...
                    a.jqx._jqxInput.prototype,
                    {
                        ...
                        render : function() {
                            ...
                            if (g.isMaterialized()
                                ...
                                c
                                        .addClass(g
                                                .toThemeProperty("jqx-input-label"));
                                i.append(c);
                                var f = a("<span></span>");
                                i.append(f);
                                ...
                                if (!(this.input instanceof HTMLInputElement)) {
                                    ...
                                    a(this.input)
                                            .addClass(
                                                    this
                                                            .toThemeProperty("jqx-input-widget"))
                                }
                                this.label = c;
                                this.bar = f;
                                ...
                                var g = this;
                                if (g.template) {
                                    g.bar.addClass(g.toThemeProperty("jqx-"
                                            + g.template));
                                    g.label.addClass(g.toThemeProperty("jqx-"
                                            + g.template))
                                }
                                if (d.length > 0) {
                                    g._hasAddons = true
                                    ...
                                    if (this.element.nodeName.toLowerCase() === "div") {
                                        ...
                                        if (b.length > 0) {
                                            ...
                                            g.baseElement.className += " "
                                                    + g
                                                            .toThemeProperty("jqx-widget jqx-rc-all jqx-input-group");
                        ...
                        _refreshClasses : function(d) {
                            var c = d ? "addClass" : "removeClass", b = "jqx-widget-content jqx-input-widget jqx-input jqx-widget", e = "jqx-popup jqx-input-popup jqx-menu jqx-menu-vertical jqx-menu-dropdown jqx-widget jqx-widget-content";
                        ...
                        refresh : function() {
                            ...
                            if (!this.baseHost) {
                                if (this.width != null
                                    ...
                                    this.element.style.width = parseInt(this.width)
                                            + "px"
                                } else {
                                ...
                                if (this.height != null
                                    ...
                                    this.element.style.height = parseInt(this.height)
                                            + "px"
                                } else {
                                ...
                                if (this._hasAddons) {
                                    ...
                                    this.input.style.width = "calc(100% - "
                                            + this._addonsWidth + "px)"
                                }
                            } else {
                                if (this.width != null
                                        && this.width.toString().indexOf("px") != -1) {
                                    this.baseElement.style.width = parseInt(this.width)
                                            + "px"
                                } else {
                                    if (this.width != undefined
                                            && !isNaN(this.width)) {
                                        this.baseElement.style.width = this.width
                                                + "px"
                                    }
                                }
                                if (this.height != null
                                        && this.height.toString().indexOf("px") != -1) {
                                    this.baseElement.style.height = parseInt(this.height)
                                            + "px"
                                } else {
                                    if (this.height != undefined
                                            && !isNaN(this.height)) {
                                        this.baseElement.style.height = this.height
                                                + "px"
                                    }
                                }
                                var d = this, e = a.jqx.browser.msie
                                        && a.jqx.browser.version < 9, c = 0;
                                ...
                                if (e) {
                                    var b = Math.max(0,
                                            d.baseElement.offsetHeight - 2);
                                    d.element.style.width = Math
                                            .max(0, (d.baseElement.offsetWidth
                                                    - c - 1))
                                            + "px";
                                    d.element.style.minHeight = b + "px";
                                    d.element.style.lineHeight = b + "px"
                                } else {
                                    d.element.style.width = "calc(100% - " + c
                                            + "px)"
                                }
                                a.jqx.utilities
                                        .resize(
                                                ...
                                                function() {
                                                    if (e
                                                            ...
                                                            && d.width
                                                                    .indexOf("%") !== -1
                                                            && !d._initiallyHidden) {
                                                        d.element.style.width = (d.baseElement.offsetWidth
                                                                - d._addonsWidth - 1)
                                                                + "px"
                                                    } else {
                                                        if (d._initiallyHidden) {
                                                            d._addonsWidth = d
                                                                    ._getAddonsWidth();
                                                            if (!e) {
                                                                d.element.style.width = "calc(100% - "
                                                                        + d._addonsWidth
                                                                        + "px)"
                                                            } else {
                                                                d.element.style.width = (d.baseElement.offsetWidth
                                                                ...
                                                                d.element.style.minHeight = f
                                                                        + "px";
                                                                d.element.style.lineHeight = f
                                                                        + "px"
                                                            }
                            ...
                            if (this.maxLength) {
                                this.element.setAttribute("maxlength",
                                        this.maxLength)
                            }
                        ...
                        _refreshPlaceHolder : function() {
                            ...
                            if (!b.isMaterialized() || !b.hint) {
                                if ("placeholder" in this.input
                                    ...
                                    b.input.setAttribute("placeHolder",
                                            b.placeHolder)
                                } else {
                                    if (b.input.value === "") {
                        ...
                        propertyChangedHandler : function(b, c, e, d) {
                            if (c === "width" && d !== e) {
                                if (b.baseHost) {
                                    ...
                                    if (a.jqx.browser.msie
                                        ...
                                        b.element.style.width = (b.baseElement.offsetWidth
                                                - b._addonsWidth - 1)
                                                + "px"
                                    }
                                } else {
                            ...
                            if (c === "placeHolder") {
                                if ((!("placeholder" in b.element) || (a.jqx.browser.msie && a.jqx.browser.version < 9))
                                        && b.input.value === e) {
                                    b.input.value = ""
                                }
                        ...
                        select : function(d, f, b) {
                            var e = this._find("jqx-fill-state-pressed",
                                    this._popupHelper);
                            var g = e.getAttribute("data-value");
                            var c = e.getAttribute("data-name");
                            this.input.value = this.renderer(c,
                                    this.input.value);
                            this.selectedItem = {
                                label : c,
                                value : g
                        ...
                        val : function(b) {
                            ...
                            if (b && b.label) {
                                ...
                                this.element
                                        .setAttribute("data-value", b.value);
                                this.element
                                        .setAttribute("data-label", b.label);
                                this.value = b;
                        ...
                        open : function() {
                            ...
                            this.$popup.style.top = this
                                    ._toPx(c.top + c.height);
                        ...
                        _render : function(f) {
                            var e = this, c = e._popupHelper.children();
                            if (c.length > 0) {
                            ...
                            var g = function(n, k) {
                                var p = n, m = document.createElement("li"), j = document
                                        .createElement("a"), h, o;
                                j.setAttribute("href", "#");
                                m.appendChild(j);
                                ...
                                m.className = e
                                        .toThemeProperty("jqx-item jqx-menu-item jqx-rc-all"
                                                + l);
                            ...
                            if (!this.dropDownWidth) {
                                this.$popup.style.width = e
                                        ._toPx(e.element.offsetWidth - 6)
                            } else {
                                this.$popup.style.width = e
                                        ._toPx(e.dropDownWidth)
                            }
                            return this
                        },
                        next : function() {
                            var c = this._find("jqx-fill-state-pressed",
                                    this._popupHelper), b = c.nextSibling;
                            a(c)
                                    .removeClass(
                                            this
                        ...
                        prev : function() {
                            var c = this._find("jqx-fill-state-pressed",
                                    this._popupHelper), b = c.previousSibling;
                            a(c)
                                    .removeClass(
                                            this
                                                    .toThemeProperty("jqx-fill-state-pressed"));
                        ...
                        addHandlers : function() {
                            var c = this, b = ".jqxInput" + c.element.id;
                            ...
                            c.addHandler(c.$popup, "mousedown" + b,
                                    function(d) {
                                        c.click(d)
                                    })
                        },
                        ...
                        mouseenter : function(b) {
                            a(
                                    this._find("jqx-fill-state-pressed",
                                            this._popupHelper))
                                    .removeClass(
                                            this
                                                    .toThemeProperty("jqx-fill-state-pressed"));
                        ...
                        _getAddonsWidth : function() {
                            var e = this, d = e.baseHost.children(), b = 0;
                            for (var c = 0; c < d.length; c++) {
                                if (d[c] !== e.element) {
                                    b += a(d[c]).outerWidth()
                                }
